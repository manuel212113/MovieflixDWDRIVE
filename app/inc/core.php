...
require(ROOT.'/app/inc/Proxy.class.php');
require(ROOT.'/app/inc/GDrive.class.php');
require(ROOT.'/app/inc/Link.class.php');
require(ROOT.'/app/inc/Stream.class.php');
require(ROOT.'/app/inc/User.class.php');
require(ROOT.'/app/inc/AutoUpdater.class.php');
